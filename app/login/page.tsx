...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden">
      ...
      {/* Content column — same width as landing for consistent card sizing */}
      <div className="relative z-10 flex flex-col items-center gap-[10px] py-[10px] w-[33vw] [container-type:inline-size]">

        {/* Intro — layout-animated, typewriter on dynamic text */}
        <motion.div
          layout
          layoutId="auth-intro"
        ...
        >
          ...
          <span className="font-display text-[36px] leading-normal" style={{ color: "var(--light-gray)" }}>
            <TypewriterText text="Welcome back to" />
          </span>
        </motion.div>

        {/* Card — expands from the landing logo card */}
        <motion.div
          layoutId="auth-card"
        ...
        >
          ...
          {/* Form — fades in after the card expands */}
          <motion.div
            className="w-full"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
